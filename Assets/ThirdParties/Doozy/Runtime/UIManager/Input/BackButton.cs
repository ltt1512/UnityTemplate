...
namespace Doozy.Runtime.UIManager.Input
{
    ...
    public class BackButton : SingletonBehaviour<BackButton>
    {
...
#if ENABLE_INPUT_SYSTEM
            MultiplayerEventSystem[] multiplayerEventSystems = FindObjectsByType<MultiplayerEventSystem>(FindObjectsSortMode.None);//FindObjectsOfType<MultiplayerEventSystem>();
        ...
        {
            #if !ENABLE_INPUT_SYSTEM && !LEGACY_INPUT_MANAGER
            return;
            #endif
